# --- START OF FILE repair_operators.py (FIXED) ---
...
# <<< SỬA LỖI: Xóa 'InsertionProcessor' khỏi dòng import >>>
from insertion_logic import find_best_global_insertion_option, find_k_best_global_insertion_options, _recalculate_fe_route_and_check_feasibility
...
# ==============================================================================
# HÀM TRỢ GIÚP NỘI BỘ CHO VIỆC CHÈN (Giữ nguyên)
# ==============================================================================
...
# ==============================================================================
# CÁC TOÁN TỬ SỬA CHỮA (REPAIR OPERATORS) - ĐÃ CẬP NHẬT
# ==============================================================================
def greedy_repair(state: "VRP2E_State", customers_to_insert: List["Customer"]) -> "VRP2E_State":
    new_state = state.copy()
    solution = new_state.solution
    # <<< SỬA LỖI: Xóa 'insertion_processor' >>>
    
    random.shuffle(customers_to_insert)

    for customer in customers_to_insert:
        # <<< SỬA LỖI: Xóa tham số 'insertion_processor' >>>
        best_option = find_best_global_insertion_option(customer, solution)
...
def regret_insertion(state: "VRP2E_State", customers_to_insert: List["Customer"], k: int = 4) -> "VRP2E_State":
    ...
    while remaining_customers:
        ...
        for customer in remaining_customers:
            # <<< SỬA LỖI: Xóa tham số 'insertion_processor' >>>
            best_options = find_k_best_global_insertion_options(customer, solution, k)
...
# ... (Các toán tử repair khác cũng được sửa tương tự) ...

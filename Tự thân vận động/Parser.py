...
class Satellite(Node):
    ...
    def __init__(self, node_id, x, y, service_time):
        ...
        # Để mô hình hóa, ta tạo 2 ID ảo cho mỗi satellite
        # ID phân phối (distribution) sẽ là ID gốc
        # ID thu gom (collection) sẽ là ID gốc + tổng số node (để đảm bảo không trùng)
        self.dist_id = self.id
        self.coll_id = -1 # Sẽ được gán giá trị sau khi biết tổng số node
    def __repr__(self):
...
class ProblemInstance:
    def __init__(self, file_path):
        ...
        # Tạo ma trận khoảng cách/thời gian
    ...
    def get_distance(self, node_id1, node_id2):
        return self.dist_matrix[node_id1][node_id2]
# --- START OF FILE solution_generator.py ---
...
from lns_algorithm import run_lns_loop
...
def create_refined_initial_solution(problem: "ProblemInstance", lns_iterations: int, q_percentage: float) -> VRP2E_State:

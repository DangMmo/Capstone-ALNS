...
class SERoute:
    def __init__(self, satellite, problem):
        ...
        # <<< THÊM MỚI: Thuộc tính total_time >>>
        self.total_dist = 0.0
        self.total_time = 0.0
    ...
    def __repr__(self):
        # <<< CẬP NHẬT: Hiển thị cả cost (dist) và time >>>
        ...
        s.append(header)
        s.append("  " + "-" * len(header))
        # ... (phần còn lại của __repr__ giữ nguyên) ...
    ...
    def calculate_full_schedule_and_slacks(self):
        # <<< CẬP NHẬT: Tính lại total_time sau khi lịch trình thay đổi >>>
        self.total_time = 0.0
        ...
        for i in range(1, len(self.nodes_id)):
            ...
            self.total_time += travel_time # Cộng dồn thời gian di chuyển
    ...
    def insert_customer_at_pos(self, customer, pos):
        ...
        # <<< CẬP NHẬT: Không cần cập nhật total_time ở đây, vì calculate_full_schedule sẽ làm >>>
    ...
    # Hàm find_best_insertion_pos giữ nguyên vì nó chỉ trả về cost_increase (khoảng cách)
...
class FERoute:
    ...
    def update_route_info(self):
        # <<< CẬP NHẬT: Tính cả total_dist và total_time >>>
        self.total_dist = 0.0
        self.total_time = 0.0
        ...
        for i in range(len(self.nodes_id) - 1):
            ...
            self.total_time += travel_time # Cộng dồn thời gian
...
class Solution:
    def __init__(self, problem):
        ...
        # <<< CẬP NHẬT: Thêm total_time >>>
        self.total_cost = 0.0 # Sẽ là tổng khoảng cách
        self.total_time = 0.0 # Sẽ là tổng thời gian

    def calculate_total_cost_and_time(self):
        # <<< CẬP NHẬT: Đổi tên và tính cả hai đại lượng >>>
